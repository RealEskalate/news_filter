...
export default function Navbar({ handler }: NavbarProps) {
  ...
  return (
    <div
      className={`bg-white p-5 h-[10vh] flex justify-between items-center ${isSticky ? "sticky top-0 left-0 w-full z-10" : "relative"}`}
    >
      <Link href={"/"}>
        <Image
          src="/Rectangle11.png"
          ...
          width={60}
          height={60}
          className="mb-2 hover:cursor-pointer transition-all duration-300 ease-in-out hover:scale-110"
        />
      </Link>
